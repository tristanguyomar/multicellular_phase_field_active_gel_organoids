...
for i,dic in enumerate(list_dic):
    ...
    os.makedirs(directory+'/all_imgs')
    os.makedirs(directory+'/data_int')
    os.makedirs(directory+'/data_test')
    os.makedirs(directory+'/data_ini_to_plot')
    os.makedirs(directory+'/data_degout_matout')
    os.makedirs(directory+'/all_plots_ini')
    os.makedirs(directory+'/all_plots_ini/comparison_before_after_reshaping/')
...
with open('launch_all.sh', 'w') as f :
    for directory in DIRECTORY:
        ...
        f.write('sbatch -o ' +NAMES[i] +' run_ini_cond.sh \n')
        f.write('cd .. \n')
        i+=1
